...
class O_Que_E_Meio_Ambiente : AppCompatActivity() {
    var simpleVideoView: VideoView? = null
    var mediaControls: MediaController? = null
    var oqueepdf: TextView? = null
    var menu: ImageView? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_oque_emeio_ambiente)
        menu = findViewById(R.id.menu)
        menu!!.setOnClickListener {
            val intent = Intent(this@O_Que_E_Meio_Ambiente, Menu::class.java)
        ...
        if (mediaControls == null) {
            ...
            mediaControls = MediaController(this@O_Que_E_Meio_Ambiente)
            mediaControls!!.setAnchorView(simpleVideoView)
        }
        // set the media controller for video view
        simpleVideoView!!.setMediaController(mediaControls)
        // set the uri for the video view
        simpleVideoView!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.oqueemeioambiente))
        // start a video
        ...
        oqueepdf = findViewById<View>(R.id.oqueepdf) as TextView
        oqueepdf!!.setOnClickListener {
            viewpdf() }
