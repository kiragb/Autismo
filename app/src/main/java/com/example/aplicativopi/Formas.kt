...
class Formas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mediaControls == null) {
            ...
            mediaControls = MediaController(this@Formas)
        ...
        formaspdf = findViewById<View>(R.id.formaspdf) as TextView
        formaspdf!!.setOnClickListener {
            viewpdf() }

    }
    private fun viewpdf() {
        // add the link of pdf
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/file/d/1GAW-Dvzh7KD65oRhhEVua_jVca5kG_aa/view?usp=share_link"))
