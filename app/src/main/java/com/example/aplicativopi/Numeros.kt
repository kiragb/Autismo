...
class Numeros : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mediaControls == null) {
            ...
            mediaControls = MediaController(this@Numeros)
            mediaControls!!.setAnchorView(simpleVideoView)
        }
        // set the media controller for video view
        simpleVideoView!!.setMediaController(mediaControls)
        // set the uri for the video view
        simpleVideoView!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.num))
        // start a video
        ...
        numpdf = findViewById<View>(R.id.numpdf) as TextView
        numpdf!!.setOnClickListener {
            viewpdf()
        }
