...
class Origanizacao : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mediaControls == null) {
            ...
            mediaControls = MediaController(this@Origanizacao)
            mediaControls!!.setAnchorView(simpleVideoView)
        }
        // set the media controller for video view
        simpleVideoView!!.setMediaController(mediaControls)
        // set the uri for the video view
        simpleVideoView!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.organizacao))
        // start a video
        ...
        origpdf = findViewById<View>(R.id.orgapdf) as TextView
        origpdf!!.setOnClickListener {
            viewpdf() }
